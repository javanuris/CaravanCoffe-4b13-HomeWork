...
public class SortingGood {
	/**
	 *  ласс, сортирует товар по определенным правилам
	 * @version 1.0
	 * @author Kalenov Nurislam
	 * */
	
	/** —ортирует список по наименованию 
...
/**  онфертирует в ArrayList<CoffeAbstract>
 * @param ArrayList<BuyItem> - список товаров
 * 
*/
